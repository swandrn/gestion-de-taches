        ...
        <tbody>
            <?php foreach ($tasks as $task): ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?action=edit_task&task_id=<?php echo htmlspecialchars($task['id']); ?>" id ="btnModifier" class="btn btn-primary btn-sm">Modifier</a>
                        <a href="index.php?action=delete_task&task_id=<?php echo htmlspecialchars($task['id']); ?>"id ="btnSupprimer" class="btn btn-danger btn-sm">Supprimer</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
